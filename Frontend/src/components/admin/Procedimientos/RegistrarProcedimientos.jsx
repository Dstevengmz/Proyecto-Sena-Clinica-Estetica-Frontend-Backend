            ...
            await axios
                ...
                .then((response) => {
                    ...
                    setFormData({
                        ...
                        requiere_evaluacion: procedimiento.requiere_evaluacion,
                        duracion: procedimiento.duracion,
                        examenes_requeridos: procedimiento.examenes_requeridos,
                        imagen: null, // No se puede mostrar la imagen directamente
                        categoria: procedimiento.categoria,
                        recomendaciones_previas:
                            procedimiento.recomendaciones_previas,
                    });
                    console.log("Datos cargados:", procedimiento);
                })
                .catch((error) => {
                    Swal.fire({
                        position: "center",
            ...
            <Form onSubmit={manejarEnvio}>
                ...
                <Form.Group>
                    ...
                    <Form.Control
                        ...
                        value={formData.examenes_requeridos}
                        onChange={manejarCambio}
                    />
                </Form.Group>
