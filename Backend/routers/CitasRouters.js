...
router.get(
  "/listarcitas",
  authorization,
  verificarRol(["doctor", "asistente", "usuario"]),
...
router.patch(
  "/editarcita-doctor/:id",
  authorization,
  verificarRol(["doctor", "asistente"]),
  CitaController.actualizarCitaDoctor
);

router.patch(
  "/editarcitausuario/:id",
  authorization,
  verificarRol(["usuario"]),
  CitaController.actualizarCitaUsuario
);
...
router.get(
  ...
  authorization,
  verificarRol(["doctor"]),
  CitaController.listarPacientesPorDoctor
);

router.get(
  "/citasusuario/:usuarioId",
  authorization,
  verificarRol(["doctor"]),
  CitaController.listarCitasPorUsuarioYDoctor
);
...
router.get(
  "/horarios/:fecha",
  authorization,
  CitaController.obtenerHorariosOcupados
);
router.post(
  "/crearordendesdecita",
  authorization,
  CitaController.crearOrdenDesdeCarrito
);
...
router.get(
  "/orden-examenes/pdf/:id",
  authorization,
  verificarRol(["usuario", "doctor", "asistente"]),
  CitaController.generarPDFExamenes
);
router.get(
  "/orden-medicamentos/pdf/:id",
  authorization,
  verificarRol(["usuario", "doctor", "asistente"]),
  CitaController.generarPDFMedicamentos
);
router.patch(
  "/marcar-examenes-subidos/:id",
  authorization,
  verificarRol(["usuario"]),
